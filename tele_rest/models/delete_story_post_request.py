...
class DeleteStoryPostRequest(BaseModel):
    """
    DeleteStoryPostRequest
    """ # noqa: E501
    business_connection_id: StrictStr = Field(description="Unique identifier of the business connection")
    story_id: StrictInt = Field(description="Unique identifier of the story to delete")
    __properties: ClassVar[List[str]] = ["business_connection_id", "story_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in DeleteStoryPostRequest) in the input: " + _key)
