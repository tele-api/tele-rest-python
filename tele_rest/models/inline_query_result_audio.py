...
class InlineQueryResultAudio(BaseModel):
    ...
    audio_url: StrictStr = Field(description="A valid URL for the audio file")
    ...
    performer: Optional[StrictStr] = Field(default=None, description="*Optional*. Performer")
    audio_duration: Optional[StrictInt] = Field(default=None, description="*Optional*. Audio duration in seconds")
    reply_markup: Optional[InlineKeyboardMarkup] = None
    input_message_content: Optional[InputMessageContent] = None
    __properties: ClassVar[List[str]] = ["type", "id", "audio_url", "title", "caption", "parse_mode", "caption_entities", "performer", "audio_duration", "reply_markup", "input_message_content"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in InlineQueryResultAudio) in the input: " + _key)
