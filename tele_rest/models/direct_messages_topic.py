...
class DirectMessagesTopic(BaseModel):
    ...
    """ # noqa: E501
    topic_id: StrictInt = Field(description="Unique identifier of the topic")
    user: Optional[User] = None
    __properties: ClassVar[List[str]] = ["topic_id", "user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in DirectMessagesTopic) in the input: " + _key)
