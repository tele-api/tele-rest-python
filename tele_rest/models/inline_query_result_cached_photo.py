...
class InlineQueryResultCachedPhoto(BaseModel):
    ...
    photo_file_id: StrictStr = Field(description="A valid file identifier of the photo")
    ...
    __properties: ClassVar[List[str]] = ["type", "id", "photo_file_id", "title", "description", "caption", "parse_mode", "caption_entities", "show_caption_above_media", "reply_markup", "input_message_content"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in InlineQueryResultCachedPhoto) in the input: " + _key)

        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'photo',
            "id": obj.get("id"),
            "photo_file_id": obj.get("photo_file_id"),
            "title": obj.get("title"),
