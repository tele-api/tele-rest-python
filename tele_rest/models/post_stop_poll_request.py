...
class PostStopPollRequest(BaseModel):
    """
    PostStopPollRequest
    """ # noqa: E501
    ...
    message_id: StrictInt = Field(description="Identifier of the original message with the poll")
    reply_markup: Optional[InlineKeyboardMarkup] = None
    __properties: ClassVar[List[str]] = ["business_connection_id", "chat_id", "message_id", "reply_markup"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PostStopPollRequest) in the input: " + _key)
