...
class Story(BaseModel):
    ...
    """ # noqa: E501
    chat: Chat
    id: StrictInt = Field(description="Unique identifier for the story in the chat")
    __properties: ClassVar[List[str]] = ["chat", "id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in Story) in the input: " + _key)
