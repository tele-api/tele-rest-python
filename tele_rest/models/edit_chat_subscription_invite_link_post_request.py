...
class EditChatSubscriptionInviteLinkPostRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["chat_id", "invite_link", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in EditChatSubscriptionInviteLinkPostRequest) in the input: " + _key)
