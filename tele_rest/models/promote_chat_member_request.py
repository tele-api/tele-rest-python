...
class PromoteChatMemberRequest(BaseModel):
    ...
    can_post_messages: Optional[StrictBool] = Field(default=None, description="Pass *True* if the administrator can post messages in the channel, approve suggested posts, or access channel statistics; for channels only")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PromoteChatMemberRequest) in the input: " + _key)
