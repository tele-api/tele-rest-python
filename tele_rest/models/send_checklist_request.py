...
class SendChecklistRequest(BaseModel):
    ...
    """ # noqa: E501
    business_connection_id: StrictStr = Field(description="Unique identifier of the business connection on behalf of which the message will be sent")
    chat_id: StrictInt = Field(description="Unique identifier for the target chat")
    checklist: InputChecklist
    disable_notification: Optional[StrictBool] = Field(default=None, description="Sends the message silently. Users will receive a notification with no sound.")
    ...
    message_effect_id: Optional[StrictStr] = Field(default=None, description="Unique identifier of the message effect to be added to the message")
    reply_parameters: Optional[ReplyParameters] = None
    reply_markup: Optional[InlineKeyboardMarkup] = None
    __properties: ClassVar[List[str]] = ["business_connection_id", "chat_id", "checklist", "disable_notification", "protect_content", "message_effect_id", "reply_parameters", "reply_markup"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in SendChecklistRequest) in the input: " + _key)

        _obj = cls.model_validate({
            "business_connection_id": obj.get("business_connection_id"),
            "chat_id": obj.get("chat_id"),
            "checklist": InputChecklist.from_dict(obj["checklist"]) if obj.get("checklist") is not None else None,
