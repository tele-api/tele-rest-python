...
BACKGROUNDTYPE_ONE_OF_SCHEMAS = ["BackgroundTypeChatTheme", "BackgroundTypeFill", "BackgroundTypePattern", "BackgroundTypeWallpaper"]
...
class BackgroundType(BaseModel):
    ...
    oneof_schema_1_validator: Optional[BackgroundTypeFill] = None
    # data type: BackgroundTypeWallpaper
    oneof_schema_2_validator: Optional[BackgroundTypeWallpaper] = None
    # data type: BackgroundTypePattern
    oneof_schema_3_validator: Optional[BackgroundTypePattern] = None
    # data type: BackgroundTypeChatTheme
    oneof_schema_4_validator: Optional[BackgroundTypeChatTheme] = None
    ...
    one_of_schemas: Set[str] = { "BackgroundTypeChatTheme", "BackgroundTypeFill", "BackgroundTypePattern", "BackgroundTypeWallpaper" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in BackgroundType with oneOf schemas: BackgroundTypeChatTheme, BackgroundTypeFill, BackgroundTypePattern, BackgroundTypeWallpaper. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in BackgroundType with oneOf schemas: BackgroundTypeChatTheme, BackgroundTypeFill, BackgroundTypePattern, BackgroundTypeWallpaper. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into BackgroundType with oneOf schemas: BackgroundTypeChatTheme, BackgroundTypeFill, BackgroundTypePattern, BackgroundTypeWallpaper. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into BackgroundType with oneOf schemas: BackgroundTypeChatTheme, BackgroundTypeFill, BackgroundTypePattern, BackgroundTypeWallpaper. Details: " + ", ".join(error_messages))
        else:
            return instance
