...
class LabeledPrice(BaseModel):
    ...
    """ # noqa: E501
    label: StrictStr = Field(description="Portion label")
    ...
    __properties: ClassVar[List[str]] = ["label", "amount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in LabeledPrice) in the input: " + _key)
