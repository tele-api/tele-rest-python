...
class ShippingOption(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="Shipping option identifier")
    title: StrictStr = Field(description="Option title")
    prices: List[LabeledPrice] = Field(description="List of price portions")
    __properties: ClassVar[List[str]] = ["id", "title", "prices"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ShippingOption) in the input: " + _key)
