...
class Message(BaseModel):
    ...
    message_thread_id: Optional[StrictInt] = Field(default=None, description="*Optional*. Unique identifier of a message thread or forum topic to which the message belongs; for supergroups and private chats only")
    ...
    is_topic_message: Optional[StrictBool] = Field(default=True, description="*Optional*. *True*, if the message is sent to a topic in a forum supergroup or a private chat with the bot")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of gift_upgrade_sent
        if self.gift_upgrade_sent:
            _dict['gift_upgrade_sent'] = self.gift_upgrade_sent.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "gift_upgrade_sent": GiftInfo.from_dict(obj["gift_upgrade_sent"]) if obj.get("gift_upgrade_sent") is not None else None,
