...
class SendStickerRequest(BaseModel):
    ...
    emoji: Optional[StrictStr] = Field(default=None, description="Emoji associated with the sticker; only for just uploaded stickers")
    ...
    __properties: ClassVar[List[str]] = ["business_connection_id", "chat_id", "message_thread_id", "direct_messages_topic_id", "sticker", "emoji", "disable_notification", "protect_content", "allow_paid_broadcast", "message_effect_id", "suggested_post_parameters", "reply_parameters", "reply_markup"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in SendStickerRequest) in the input: " + _key)
