...
class ChecklistTask(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt = Field(description="Unique identifier of the task")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ChecklistTask) in the input: " + _key)
