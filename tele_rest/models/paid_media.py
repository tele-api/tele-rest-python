...
PAIDMEDIA_ONE_OF_SCHEMAS = ["PaidMediaPhoto", "PaidMediaPreview", "PaidMediaVideo"]
...
class PaidMedia(BaseModel):
    ...
    oneof_schema_1_validator: Optional[PaidMediaPreview] = None
    # data type: PaidMediaPhoto
    oneof_schema_2_validator: Optional[PaidMediaPhoto] = None
    # data type: PaidMediaVideo
    oneof_schema_3_validator: Optional[PaidMediaVideo] = None
    actual_instance: Optional[Union[PaidMediaPhoto, PaidMediaPreview, PaidMediaVideo]] = None
    one_of_schemas: Set[str] = { "PaidMediaPhoto", "PaidMediaPreview", "PaidMediaVideo" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in PaidMedia with oneOf schemas: PaidMediaPhoto, PaidMediaPreview, PaidMediaVideo. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in PaidMedia with oneOf schemas: PaidMediaPhoto, PaidMediaPreview, PaidMediaVideo. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into PaidMedia with oneOf schemas: PaidMediaPhoto, PaidMediaPreview, PaidMediaVideo. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into PaidMedia with oneOf schemas: PaidMediaPhoto, PaidMediaPreview, PaidMediaVideo. Details: " + ", ".join(error_messages))
        else:
            return instance
