...
class InlineQueryResultGame(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "id", "game_short_name", "reply_markup"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in InlineQueryResultGame) in the input: " + _key)

        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'game',
            "id": obj.get("id"),
