...
class EditMessageMediaRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["business_connection_id", "chat_id", "message_id", "inline_message_id", "media", "reply_markup"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in EditMessageMediaRequest) in the input: " + _key)
        ...
        _obj = cls.model_validate({
            ...
            "media": InputMedia.from_dict(obj["media"]) if obj.get("media") is not None else None,
