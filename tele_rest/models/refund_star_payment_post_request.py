...
class RefundStarPaymentPostRequest(BaseModel):
    """
    RefundStarPaymentPostRequest
    """ # noqa: E501
    user_id: StrictInt = Field(description="Identifier of the user whose payment will be refunded")
    telegram_payment_charge_id: StrictStr = Field(description="Telegram payment identifier")
    __properties: ClassVar[List[str]] = ["user_id", "telegram_payment_charge_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in RefundStarPaymentPostRequest) in the input: " + _key)
