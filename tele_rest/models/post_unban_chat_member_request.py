...
class PostUnbanChatMemberRequest(BaseModel):
    """
    ...
    only_if_banned: Optional[StrictBool] = Field(default=None, description="Do nothing if the user is not banned")
    __properties: ClassVar[List[str]] = ["chat_id", "user_id", "only_if_banned"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PostUnbanChatMemberRequest) in the input: " + _key)

        _obj = cls.model_validate({
            "chat_id": PostBanChatMemberRequestChatId.from_dict(obj["chat_id"]) if obj.get("chat_id") is not None else None,
            "user_id": obj.get("user_id"),
            "only_if_banned": obj.get("only_if_banned")
        })
        return _obj
