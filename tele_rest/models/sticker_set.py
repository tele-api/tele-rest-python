...
class StickerSet(BaseModel):
    ...
    sticker_type: StrictStr = Field(description="Type of stickers in the set, currently one of “regular”, “mask”, “custom\\_emoji”")
    stickers: List[Sticker] = Field(description="List of all set stickers")
    thumbnail: Optional[PhotoSize] = None
    __properties: ClassVar[List[str]] = ["name", "title", "sticker_type", "stickers", "thumbnail"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in StickerSet) in the input: " + _key)
