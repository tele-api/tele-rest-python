...
class LoginUrl(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["url", "forward_text", "bot_username", "request_write_access"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in LoginUrl) in the input: " + _key)
