...
class ConvertGiftToStarsPostRequest(BaseModel):
    """
    ...
    owned_gift_id: StrictStr = Field(description="Unique identifier of the regular gift that should be converted to Telegram Stars")
    __properties: ClassVar[List[str]] = ["business_connection_id", "owned_gift_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ConvertGiftToStarsPostRequest) in the input: " + _key)
