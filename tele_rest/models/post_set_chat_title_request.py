...
class PostSetChatTitleRequest(BaseModel):
    """
    PostSetChatTitleRequest
    """ # noqa: E501
    chat_id: PostSendMessageRequestChatId
    title: Annotated[str, Field(min_length=1, strict=True, max_length=128)] = Field(description="New chat title, 1-128 characters")
    __properties: ClassVar[List[str]] = ["chat_id", "title"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PostSetChatTitleRequest) in the input: " + _key)
