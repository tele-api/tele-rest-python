    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in WriteAccessAllowed) in the input: " + _key)

        _obj = cls.model_validate({
            "from_request": obj.get("from_request"),
            "web_app_name": obj.get("web_app_name"),
            "from_attachment_menu": obj.get("from_attachment_menu")
        })
        return _obj
