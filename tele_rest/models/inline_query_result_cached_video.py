...
class InlineQueryResultCachedVideo(BaseModel):
    ...
    video_file_id: StrictStr = Field(description="A valid file identifier for the video file")
    ...
    __properties: ClassVar[List[str]] = ["type", "id", "video_file_id", "title", "description", "caption", "parse_mode", "caption_entities", "show_caption_above_media", "reply_markup", "input_message_content"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in InlineQueryResultCachedVideo) in the input: " + _key)

        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'video',
            "id": obj.get("id"),
            "video_file_id": obj.get("video_file_id"),
            "title": obj.get("title"),
