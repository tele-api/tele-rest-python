...
class InputContactMessageContent(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["phone_number", "first_name", "last_name", "vcard"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in InputContactMessageContent) in the input: " + _key)
