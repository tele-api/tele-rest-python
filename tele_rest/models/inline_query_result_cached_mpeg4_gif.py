...
class InlineQueryResultCachedMpeg4Gif(BaseModel):
    ...
    mpeg4_file_id: StrictStr = Field(description="A valid file identifier for the MPEG4 file")
    ...
    __properties: ClassVar[List[str]] = ["type", "id", "mpeg4_file_id", "title", "caption", "parse_mode", "caption_entities", "show_caption_above_media", "reply_markup", "input_message_content"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in InlineQueryResultCachedMpeg4Gif) in the input: " + _key)

        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'mpeg4_gif',
            "id": obj.get("id"),
            "mpeg4_file_id": obj.get("mpeg4_file_id"),
            "title": obj.get("title"),
