...
class Audio(BaseModel):
    ...
    duration: StrictInt = Field(description="Duration of the audio in seconds as defined by the sender")
    performer: Optional[StrictStr] = Field(default=None, description="*Optional*. Performer of the audio as defined by the sender or by audio tags")
    title: Optional[StrictStr] = Field(default=None, description="*Optional*. Title of the audio as defined by the sender or by audio tags")
    ...
    __properties: ClassVar[List[str]] = ["file_id", "file_unique_id", "duration", "performer", "title", "file_name", "mime_type", "file_size", "thumbnail"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in Audio) in the input: " + _key)
