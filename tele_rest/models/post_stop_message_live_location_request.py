...
class PostStopMessageLiveLocationRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["business_connection_id", "chat_id", "message_id", "inline_message_id", "reply_markup"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PostStopMessageLiveLocationRequest) in the input: " + _key)

        _obj = cls.model_validate({
            "business_connection_id": obj.get("business_connection_id"),
            "chat_id": PostEditMessageTextRequestChatId.from_dict(obj["chat_id"]) if obj.get("chat_id") is not None else None,
