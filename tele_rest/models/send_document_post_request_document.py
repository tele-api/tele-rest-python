...
SENDDOCUMENTPOSTREQUESTDOCUMENT_ANY_OF_SCHEMAS = ["object", "str"]
...
class SendDocumentPostRequestDocument(BaseModel):
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in SendDocumentPostRequestDocument with anyOf schemas: object, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into SendDocumentPostRequestDocument with anyOf schemas: object, str. Details: " + ", ".join(error_messages))
        else:
            return instance
