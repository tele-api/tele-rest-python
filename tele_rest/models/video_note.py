...
class VideoNote(BaseModel):
    ...
    length: StrictInt = Field(description="Video width and height (diameter of the video message) as defined by the sender")
    ...
    __properties: ClassVar[List[str]] = ["file_id", "file_unique_id", "length", "duration", "thumbnail", "file_size"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in VideoNote) in the input: " + _key)
