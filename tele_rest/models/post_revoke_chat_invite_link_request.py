...
class PostRevokeChatInviteLinkRequest(BaseModel):
    """
    PostRevokeChatInviteLinkRequest
    """ # noqa: E501
    chat_id: PostRevokeChatInviteLinkRequestChatId
    invite_link: StrictStr = Field(description="The invite link to revoke")
    __properties: ClassVar[List[str]] = ["chat_id", "invite_link"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PostRevokeChatInviteLinkRequest) in the input: " + _key)

        _obj = cls.model_validate({
            "chat_id": PostRevokeChatInviteLinkRequestChatId.from_dict(obj["chat_id"]) if obj.get("chat_id") is not None else None,
