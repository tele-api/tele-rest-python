...
class PostDeleteMessageRequest(BaseModel):
    """
    PostDeleteMessageRequest
    """ # noqa: E501
    chat_id: PostSendMessageRequestChatId
    message_id: StrictInt = Field(description="Identifier of the message to delete")
    __properties: ClassVar[List[str]] = ["chat_id", "message_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PostDeleteMessageRequest) in the input: " + _key)
