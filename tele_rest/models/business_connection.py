...
class BusinessConnection(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier of the business connection")
    user: User
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in BusinessConnection) in the input: " + _key)
        ...
        _obj = cls.model_validate({
            ...
            "date": obj.get("date"),
            "rights": BusinessBotRights.from_dict(obj["rights"]) if obj.get("rights") is not None else None,
