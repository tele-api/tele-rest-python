...
class ForumTopic(BaseModel):
    ...
    """ # noqa: E501
    message_thread_id: StrictInt = Field(description="Unique identifier of the forum topic")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ForumTopic) in the input: " + _key)
