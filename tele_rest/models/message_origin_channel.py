...
class MessageOriginChannel(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr = Field(description="Type of the message origin, always “channel”")
    ...
    author_signature: Optional[StrictStr] = Field(default=None, description="*Optional*. Signature of the original post author")
    __properties: ClassVar[List[str]] = ["type", "date", "chat", "message_id", "author_signature"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in MessageOriginChannel) in the input: " + _key)

        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'channel',
            "date": obj.get("date"),
