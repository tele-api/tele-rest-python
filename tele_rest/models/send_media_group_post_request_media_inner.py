...
SENDMEDIAGROUPPOSTREQUESTMEDIAINNER_ANY_OF_SCHEMAS = ["InputMediaAudio", "InputMediaDocument", "InputMediaPhoto", "InputMediaVideo"]
...
class SendMediaGroupPostRequestMediaInner(BaseModel):
    ...
    anyof_schema_1_validator: Optional[InputMediaAudio] = None
    # data type: InputMediaDocument
    anyof_schema_2_validator: Optional[InputMediaDocument] = None
    # data type: InputMediaPhoto
    anyof_schema_3_validator: Optional[InputMediaPhoto] = None
    # data type: InputMediaVideo
    anyof_schema_4_validator: Optional[InputMediaVideo] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[InputMediaAudio, InputMediaDocument, InputMediaPhoto, InputMediaVideo]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "InputMediaAudio", "InputMediaDocument", "InputMediaPhoto", "InputMediaVideo" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in SendMediaGroupPostRequestMediaInner with anyOf schemas: InputMediaAudio, InputMediaDocument, InputMediaPhoto, InputMediaVideo. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into SendMediaGroupPostRequestMediaInner with anyOf schemas: InputMediaAudio, InputMediaDocument, InputMediaPhoto, InputMediaVideo. Details: " + ", ".join(error_messages))
        else:
            return instance
