...
class PostSetChatStickerSetRequest(BaseModel):
    """
    PostSetChatStickerSetRequest
    """ # noqa: E501
    chat_id: PostRestrictChatMemberRequestChatId
    sticker_set_name: StrictStr = Field(description="Name of the sticker set to be set as the group sticker set")
    __properties: ClassVar[List[str]] = ["chat_id", "sticker_set_name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PostSetChatStickerSetRequest) in the input: " + _key)
