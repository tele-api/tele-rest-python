...
class PostStoryRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["business_connection_id", "content", "active_period", "caption", "parse_mode", "caption_entities", "areas", "post_to_chat_page", "protect_content"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PostStoryRequest) in the input: " + _key)
