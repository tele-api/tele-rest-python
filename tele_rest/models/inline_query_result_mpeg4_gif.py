...
class InlineQueryResultMpeg4Gif(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr = Field(description="Type of the result, must be *mpeg4\\_gif*")
    id: StrictStr = Field(description="Unique identifier for this result, 1-64 bytes")
    mpeg4_url: StrictStr = Field(description="A valid URL for the MPEG4 file")
    mpeg4_width: Optional[StrictInt] = Field(default=None, description="*Optional*. Video width")
    mpeg4_height: Optional[StrictInt] = Field(default=None, description="*Optional*. Video height")
    mpeg4_duration: Optional[StrictInt] = Field(default=None, description="*Optional*. Video duration in seconds")
    ...
    caption: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1024)]] = Field(default=None, description="*Optional*. Caption of the MPEG-4 file to be sent, 0-1024 characters after entities parsing")
    ...
    __properties: ClassVar[List[str]] = ["type", "id", "mpeg4_url", "mpeg4_width", "mpeg4_height", "mpeg4_duration", "thumbnail_url", "thumbnail_mime_type", "title", "caption", "parse_mode", "caption_entities", "show_caption_above_media", "reply_markup", "input_message_content"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in InlineQueryResultMpeg4Gif) in the input: " + _key)

        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'mpeg4_gif',
            "id": obj.get("id"),
            "mpeg4_url": obj.get("mpeg4_url"),
            "mpeg4_width": obj.get("mpeg4_width"),
            "mpeg4_height": obj.get("mpeg4_height"),
            "mpeg4_duration": obj.get("mpeg4_duration"),
