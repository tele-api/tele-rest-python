...
class TransactionPartnerChat(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr = Field(description="Type of the transaction partner, always “chat”")
    chat: Chat
    gift: Optional[Gift] = None
    __properties: ClassVar[List[str]] = ["type", "chat", "gift"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in TransactionPartnerChat) in the input: " + _key)
