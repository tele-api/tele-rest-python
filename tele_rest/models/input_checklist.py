...
class InputChecklist(BaseModel):
    ...
    others_can_mark_tasks_as_done: Optional[StrictBool] = Field(default=None, description="*Optional*. Pass *True* if other users can mark tasks as done or not done in the checklist")
    __properties: ClassVar[List[str]] = ["title", "parse_mode", "title_entities", "tasks", "others_can_add_tasks", "others_can_mark_tasks_as_done"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in InputChecklist) in the input: " + _key)
        ...
        _obj = cls.model_validate({
            ...
            "tasks": [InputChecklistTask.from_dict(_item) for _item in obj["tasks"]] if obj.get("tasks") is not None else None,
            "others_can_add_tasks": obj.get("others_can_add_tasks"),
            "others_can_mark_tasks_as_done": obj.get("others_can_mark_tasks_as_done")
        })
        return _obj
