...
class MessageOriginUser(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr = Field(description="Type of the message origin, always “user”")
    var_date: StrictInt = Field(description="Date the message was sent originally in Unix time", alias="date")
    sender_user: User
    __properties: ClassVar[List[str]] = ["type", "date", "sender_user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in MessageOriginUser) in the input: " + _key)
