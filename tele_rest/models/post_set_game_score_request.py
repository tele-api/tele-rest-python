...
class PostSetGameScoreRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["user_id", "score", "force", "disable_edit_message", "chat_id", "message_id", "inline_message_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PostSetGameScoreRequest) in the input: " + _key)
