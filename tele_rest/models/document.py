...
class Document(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["file_id", "file_unique_id", "thumbnail", "file_name", "mime_type", "file_size"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in Document) in the input: " + _key)
