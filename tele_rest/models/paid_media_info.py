...
class PaidMediaInfo(BaseModel):
    ...
    """ # noqa: E501
    star_count: StrictInt = Field(description="The number of Telegram Stars that must be paid to buy access to the media")
    paid_media: List[PaidMedia] = Field(description="Information about the paid media")
    __properties: ClassVar[List[str]] = ["star_count", "paid_media"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PaidMediaInfo) in the input: " + _key)
