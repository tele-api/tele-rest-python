...
class EditForumTopicPostRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["chat_id", "message_thread_id", "name", "icon_custom_emoji_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in EditForumTopicPostRequest) in the input: " + _key)
