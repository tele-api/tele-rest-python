...
INPUTMESSAGECONTENT_ONE_OF_SCHEMAS = ["InputContactMessageContent", "InputInvoiceMessageContent", "InputLocationMessageContent", "InputTextMessageContent", "InputVenueMessageContent"]
...
class InputMessageContent(BaseModel):
    ...
    oneof_schema_1_validator: Optional[InputTextMessageContent] = None
    # data type: InputLocationMessageContent
    oneof_schema_2_validator: Optional[InputLocationMessageContent] = None
    # data type: InputVenueMessageContent
    oneof_schema_3_validator: Optional[InputVenueMessageContent] = None
    # data type: InputContactMessageContent
    oneof_schema_4_validator: Optional[InputContactMessageContent] = None
    # data type: InputInvoiceMessageContent
    oneof_schema_5_validator: Optional[InputInvoiceMessageContent] = None
    ...
    one_of_schemas: Set[str] = { "InputContactMessageContent", "InputInvoiceMessageContent", "InputLocationMessageContent", "InputTextMessageContent", "InputVenueMessageContent" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in InputMessageContent with oneOf schemas: InputContactMessageContent, InputInvoiceMessageContent, InputLocationMessageContent, InputTextMessageContent, InputVenueMessageContent. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in InputMessageContent with oneOf schemas: InputContactMessageContent, InputInvoiceMessageContent, InputLocationMessageContent, InputTextMessageContent, InputVenueMessageContent. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into InputMessageContent with oneOf schemas: InputContactMessageContent, InputInvoiceMessageContent, InputLocationMessageContent, InputTextMessageContent, InputVenueMessageContent. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into InputMessageContent with oneOf schemas: InputContactMessageContent, InputInvoiceMessageContent, InputLocationMessageContent, InputTextMessageContent, InputVenueMessageContent. Details: " + ", ".join(error_messages))
        else:
            return instance
