...
MENUBUTTON_ANY_OF_SCHEMAS = ["MenuButtonCommands", "MenuButtonDefault", "MenuButtonWebApp"]
...
class MenuButton(BaseModel):
    ...
    anyof_schema_1_validator: Optional[MenuButtonCommands] = None
    # data type: MenuButtonWebApp
    anyof_schema_2_validator: Optional[MenuButtonWebApp] = None
    # data type: MenuButtonDefault
    anyof_schema_3_validator: Optional[MenuButtonDefault] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[MenuButtonCommands, MenuButtonDefault, MenuButtonWebApp]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "MenuButtonCommands", "MenuButtonDefault", "MenuButtonWebApp" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in MenuButton with anyOf schemas: MenuButtonCommands, MenuButtonDefault, MenuButtonWebApp. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into MenuButton with anyOf schemas: MenuButtonCommands, MenuButtonDefault, MenuButtonWebApp. Details: " + ", ".join(error_messages))
        else:
            return instance
