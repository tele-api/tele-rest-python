...
class ForumTopicCreated(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "icon_color", "icon_custom_emoji_id", "is_name_implicit"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ForumTopicCreated) in the input: " + _key)
