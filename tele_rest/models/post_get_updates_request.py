...
class PostGetUpdatesRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["offset", "limit", "timeout", "allowed_updates"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostGetUpdatesRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostGetUpdatesRequest from a dict"""
        if obj is None:
            return None
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PostGetUpdatesRequest) in the input: " + _key)
