...
class InputPaidMediaPhoto(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr = Field(description="Type of the media, must be *photo*")
    ...
    __properties: ClassVar[List[str]] = ["type", "media"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in InputPaidMediaPhoto) in the input: " + _key)
