...
class TransferBusinessAccountStarsPostRequest(BaseModel):
    """
    ...
    star_count: StrictInt = Field(description="Number of Telegram Stars to transfer; 1-10000")
    __properties: ClassVar[List[str]] = ["business_connection_id", "star_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in TransferBusinessAccountStarsPostRequest) in the input: " + _key)
