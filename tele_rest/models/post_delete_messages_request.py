...
class PostDeleteMessagesRequest(BaseModel):
    """
    PostDeleteMessagesRequest
    """ # noqa: E501
    chat_id: PostSendMessageRequestChatId
    message_ids: List[StrictInt] = Field(description="A JSON-serialized list of 1-100 identifiers of messages to delete. See [deleteMessage](https://core.telegram.org/bots/api/#deletemessage) for limitations on which messages can be deleted")
    __properties: ClassVar[List[str]] = ["chat_id", "message_ids"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PostDeleteMessagesRequest) in the input: " + _key)
