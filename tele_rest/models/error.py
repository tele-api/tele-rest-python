...
class Error(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ok", "error_code", "description", "parameters"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ok": obj.get("ok") if obj.get("ok") is not None else False,
            "error_code": obj.get("error_code"),
            "description": obj.get("description"),
            "parameters": ResponseParameters.from_dict(obj["parameters"]) if obj.get("parameters") is not None else None
        })
        return _obj
