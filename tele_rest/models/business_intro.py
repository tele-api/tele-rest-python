...
class BusinessIntro(BaseModel):
    ...
    """ # noqa: E501
    title: Optional[StrictStr] = Field(default=None, description="*Optional*. Title text of the business intro")
    message: Optional[StrictStr] = Field(default=None, description="*Optional*. Message text of the business intro")
    sticker: Optional[Sticker] = None
    __properties: ClassVar[List[str]] = ["title", "message", "sticker"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in BusinessIntro) in the input: " + _key)
