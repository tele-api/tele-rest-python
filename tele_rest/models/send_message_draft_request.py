...
class SendMessageDraftRequest(BaseModel):
    """
    Request parameters for sendMessageDraft
    """ # noqa: E501
    chat_id: StrictInt = Field(description="Unique identifier for the target private chat")
    message_thread_id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the target message thread")
    draft_id: StrictInt = Field(description="Unique identifier of the message draft; must be non-zero. Changes of drafts with the same identifier are animated")
    ...
    __properties: ClassVar[List[str]] = ["chat_id", "message_thread_id", "draft_id", "text", "parse_mode", "entities"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in SendMessageDraftRequest) in the input: " + _key)
