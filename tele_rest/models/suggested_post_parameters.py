...
class SuggestedPostParameters(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["price", "send_date"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in SuggestedPostParameters) in the input: " + _key)
