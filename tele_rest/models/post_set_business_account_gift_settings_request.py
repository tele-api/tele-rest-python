...
class PostSetBusinessAccountGiftSettingsRequest(BaseModel):
    """
    ...
    show_gift_button: StrictBool = Field(description="Pass True, if a button for sending a gift to the user or by the business account must always be shown in the input field")
    accepted_gift_types: AcceptedGiftTypes
    __properties: ClassVar[List[str]] = ["business_connection_id", "show_gift_button", "accepted_gift_types"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PostSetBusinessAccountGiftSettingsRequest) in the input: " + _key)

        _obj = cls.model_validate({
            "business_connection_id": obj.get("business_connection_id"),
            "show_gift_button": obj.get("show_gift_button"),
