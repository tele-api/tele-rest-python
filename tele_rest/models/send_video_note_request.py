...
class SendVideoNoteRequest(BaseModel):
    ...
    length: Optional[StrictInt] = Field(default=None, description="Video width and height, i.e. diameter of the video message")
    ...
    __properties: ClassVar[List[str]] = ["business_connection_id", "chat_id", "message_thread_id", "direct_messages_topic_id", "video_note", "duration", "length", "thumbnail", "disable_notification", "protect_content", "allow_paid_broadcast", "message_effect_id", "suggested_post_parameters", "reply_parameters", "reply_markup"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if video_note (nullable) is None
        # and model_fields_set contains the field
        if self.video_note is None and "video_note" in self.model_fields_set:
            _dict['video_note'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in SendVideoNoteRequest) in the input: " + _key)
