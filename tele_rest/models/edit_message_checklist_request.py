...
class EditMessageChecklistRequest(BaseModel):
    """
    ...
    message_id: StrictInt = Field(description="Unique identifier for the target message")
    checklist: InputChecklist
    reply_markup: Optional[InlineKeyboardMarkup] = None
    __properties: ClassVar[List[str]] = ["business_connection_id", "chat_id", "message_id", "checklist", "reply_markup"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in EditMessageChecklistRequest) in the input: " + _key)
