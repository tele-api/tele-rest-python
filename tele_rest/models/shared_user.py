...
class SharedUser(BaseModel):
    ...
    first_name: Optional[StrictStr] = Field(default=None, description="*Optional*. First name of the user, if the name was requested by the bot")
    last_name: Optional[StrictStr] = Field(default=None, description="*Optional*. Last name of the user, if the name was requested by the bot")
    username: Optional[StrictStr] = Field(default=None, description="*Optional*. Username of the user, if the username was requested by the bot")
    ...
    __properties: ClassVar[List[str]] = ["user_id", "first_name", "last_name", "username", "photo"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in SharedUser) in the input: " + _key)
