...
class PassportFile(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["file_id", "file_unique_id", "file_size", "file_date"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PassportFile) in the input: " + _key)
