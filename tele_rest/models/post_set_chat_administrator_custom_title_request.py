...
class PostSetChatAdministratorCustomTitleRequest(BaseModel):
    """
    ...
    custom_title: Annotated[str, Field(min_length=0, strict=True, max_length=16)] = Field(description="New custom title for the administrator; 0-16 characters, emoji are not allowed")
    __properties: ClassVar[List[str]] = ["chat_id", "user_id", "custom_title"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PostSetChatAdministratorCustomTitleRequest) in the input: " + _key)
