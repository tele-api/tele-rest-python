...
class PostSetChatDescriptionRequest(BaseModel):
    """
    PostSetChatDescriptionRequest
    """ # noqa: E501
    chat_id: PostSendMessageRequestChatId
    description: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=255)]] = Field(default=None, description="New chat description, 0-255 characters")
    __properties: ClassVar[List[str]] = ["chat_id", "description"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PostSetChatDescriptionRequest) in the input: " + _key)
