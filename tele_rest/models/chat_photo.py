...
class ChatPhoto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["small_file_id", "small_file_unique_id", "big_file_id", "big_file_unique_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ChatPhoto) in the input: " + _key)
