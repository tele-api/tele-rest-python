...
class BusinessMessagesDeleted(BaseModel):
    ...
    chat: Chat
    message_ids: List[StrictInt] = Field(description="The list of identifiers of deleted messages in the chat of the business account")
    __properties: ClassVar[List[str]] = ["business_connection_id", "chat", "message_ids"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in BusinessMessagesDeleted) in the input: " + _key)
