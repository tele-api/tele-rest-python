...
class EditStoryRequest(BaseModel):
    ...
    story_id: StrictInt = Field(description="Unique identifier of the story to edit")
    content: InputStoryContent
    caption: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=2048)]] = Field(default=None, description="Caption of the story, 0-2048 characters after entities parsing")
    parse_mode: Optional[StrictStr] = Field(default=None, description="Mode for parsing entities in the story caption. See [formatting options](https://core.telegram.org/bots/api/#formatting-options) for more details.")
    ...
    areas: Optional[List[StoryArea]] = Field(default=None, description="A JSON-serialized list of clickable areas to be shown on the story")
    __properties: ClassVar[List[str]] = ["business_connection_id", "story_id", "content", "caption", "parse_mode", "caption_entities", "areas"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in EditStoryRequest) in the input: " + _key)

        _obj = cls.model_validate({
            "business_connection_id": obj.get("business_connection_id"),
            "story_id": obj.get("story_id"),
            "content": InputStoryContent.from_dict(obj["content"]) if obj.get("content") is not None else None,
            ...
            "areas": [StoryArea.from_dict(_item) for _item in obj["areas"]] if obj.get("areas") is not None else None
        })
        return _obj
