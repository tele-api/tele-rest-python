    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ReplyKeyboardRemove) in the input: " + _key)

        _obj = cls.model_validate({
            "remove_keyboard": obj.get("remove_keyboard") if obj.get("remove_keyboard") is not None else True,
