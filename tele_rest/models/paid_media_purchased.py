...
class PaidMediaPurchased(BaseModel):
    ...
    paid_media_payload: StrictStr = Field(description="Bot-specified paid media payload")
    __properties: ClassVar[List[str]] = ["from", "paid_media_payload"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PaidMediaPurchased) in the input: " + _key)
