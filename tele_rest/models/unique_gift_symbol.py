...
class UniqueGiftSymbol(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="Name of the symbol")
    sticker: Sticker
    rarity_per_mille: StrictInt = Field(description="The number of unique gifts that receive this model for every 1000 gifts upgraded")
    __properties: ClassVar[List[str]] = ["name", "sticker", "rarity_per_mille"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in UniqueGiftSymbol) in the input: " + _key)
