...
class BotCommandScopeDefault(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr = Field(description="Scope type, must be *default*")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in BotCommandScopeDefault) in the input: " + _key)
