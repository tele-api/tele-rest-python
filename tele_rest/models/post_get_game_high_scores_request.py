...
class PostGetGameHighScoresRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["user_id", "chat_id", "message_id", "inline_message_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PostGetGameHighScoresRequest) in the input: " + _key)
