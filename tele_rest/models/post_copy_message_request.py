...
class PostCopyMessageRequest(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PostCopyMessageRequest) in the input: " + _key)
        ...
        _obj = cls.model_validate({
            ...
            "from_chat_id": PostForwardMessageRequestFromChatId.from_dict(obj["from_chat_id"]) if obj.get("from_chat_id") is not None else None,
