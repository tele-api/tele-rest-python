...
class MessageAutoDeleteTimerChanged(BaseModel):
    ...
    """ # noqa: E501
    message_auto_delete_time: StrictInt = Field(description="New auto-delete time for messages in the chat; in seconds")
    __properties: ClassVar[List[str]] = ["message_auto_delete_time"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in MessageAutoDeleteTimerChanged) in the input: " + _key)
