...
class TestInlineQueryResultCachedSticker(unittest.TestCase):
    """InlineQueryResultCachedSticker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InlineQueryResultCachedSticker:
        """Test InlineQueryResultCachedSticker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InlineQueryResultCachedSticker`
        """
    ...
    def testInlineQueryResultCachedSticker(self):
        """Test InlineQueryResultCachedSticker"""
