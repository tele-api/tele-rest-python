...
class TestSendPaidMediaResponse(unittest.TestCase):
    """SendPaidMediaResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendPaidMediaResponse:
        """Test SendPaidMediaResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendPaidMediaResponse`
        """
        model = SendPaidMediaResponse()
        if include_optional:
    ...
    def testSendPaidMediaResponse(self):
        """Test SendPaidMediaResponse"""
