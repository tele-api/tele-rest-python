...
class TestSendVideoResponse(unittest.TestCase):
    """SendVideoResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendVideoResponse:
        """Test SendVideoResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendVideoResponse`
        """
        model = SendVideoResponse()
        if include_optional:
    ...
    def testSendVideoResponse(self):
        """Test SendVideoResponse"""
