...
class TestSendGameRequest(unittest.TestCase):
    """SendGameRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendGameRequest:
        """Test SendGameRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendGameRequest`
        """
        model = SendGameRequest()
        if include_optional:
