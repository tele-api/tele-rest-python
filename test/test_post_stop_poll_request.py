...
class TestPostStopPollRequest(unittest.TestCase):
    """PostStopPollRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostStopPollRequest:
        """Test PostStopPollRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostStopPollRequest`
        """
        model = PostStopPollRequest()
        if include_optional:
            return PostStopPollRequest(
    ...
    def testPostStopPollRequest(self):
        """Test PostStopPollRequest"""
