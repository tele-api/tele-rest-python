...
class TestSuggestedPostApproved(unittest.TestCase):
    """SuggestedPostApproved unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SuggestedPostApproved:
        """Test SuggestedPostApproved
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SuggestedPostApproved`
        """
        model = SuggestedPostApproved()
        if include_optional:
    ...
    def testSuggestedPostApproved(self):
        """Test SuggestedPostApproved"""
