...
class TestPostEditMessageLiveLocationRequest(unittest.TestCase):
    """PostEditMessageLiveLocationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostEditMessageLiveLocationRequest:
        """Test PostEditMessageLiveLocationRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostEditMessageLiveLocationRequest`
        """
        model = PostEditMessageLiveLocationRequest()
        if include_optional:
            return PostEditMessageLiveLocationRequest(
    ...
    def testPostEditMessageLiveLocationRequest(self):
        """Test PostEditMessageLiveLocationRequest"""
