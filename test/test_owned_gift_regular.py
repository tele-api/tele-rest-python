...
class TestOwnedGiftRegular(unittest.TestCase):
    """OwnedGiftRegular unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OwnedGiftRegular:
        """Test OwnedGiftRegular
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OwnedGiftRegular`
        """
        model = OwnedGiftRegular()
        if include_optional:
