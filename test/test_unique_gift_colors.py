...
class TestUniqueGiftColors(unittest.TestCase):
    """UniqueGiftColors unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UniqueGiftColors:
        """Test UniqueGiftColors
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UniqueGiftColors`
        """
        model = UniqueGiftColors()
        if include_optional:
