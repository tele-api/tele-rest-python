...
class TestInlineQueryResultCachedVoice(unittest.TestCase):
    """InlineQueryResultCachedVoice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InlineQueryResultCachedVoice:
        """Test InlineQueryResultCachedVoice
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InlineQueryResultCachedVoice`
        """
    ...
    def testInlineQueryResultCachedVoice(self):
        """Test InlineQueryResultCachedVoice"""
