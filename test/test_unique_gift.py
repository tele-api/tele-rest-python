...
class TestUniqueGift(unittest.TestCase):
    """UniqueGift unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UniqueGift:
        """Test UniqueGift
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UniqueGift`
        """
        model = UniqueGift()
        if include_optional:
            return UniqueGift(
