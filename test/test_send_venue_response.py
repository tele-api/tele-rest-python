...
class TestSendVenueResponse(unittest.TestCase):
    """SendVenueResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendVenueResponse:
        """Test SendVenueResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendVenueResponse`
        """
        model = SendVenueResponse()
        if include_optional:
    ...
    def testSendVenueResponse(self):
        """Test SendVenueResponse"""
