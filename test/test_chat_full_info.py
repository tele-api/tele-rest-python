...
class TestChatFullInfo(unittest.TestCase):
    """ChatFullInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChatFullInfo:
        """Test ChatFullInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChatFullInfo`
        """
        model = ChatFullInfo()
        if include_optional:
            return ChatFullInfo(
