...
class TestEditMessageTextResponseResult(unittest.TestCase):
    """EditMessageTextResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EditMessageTextResponseResult:
        """Test EditMessageTextResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EditMessageTextResponseResult`
        """
        model = EditMessageTextResponseResult()
        if include_optional:
            return EditMessageTextResponseResult(
                ...
                reply_to_message = tele_rest.models.message.Message(
                    ...
                    checklist_tasks_done = tele_rest.models.checklist_tasks_done.ChecklistTasksDone(
                        checklist_message = tele_rest.models.message.Message(
                            message_id = 56, 
                            message_thread_id = 56, 
                            sender_boost_count = 56, 
                            date = 56, 
    ...
    def testEditMessageTextResponseResult(self):
        """Test EditMessageTextResponseResult"""
