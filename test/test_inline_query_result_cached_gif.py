...
class TestInlineQueryResultCachedGif(unittest.TestCase):
    """InlineQueryResultCachedGif unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InlineQueryResultCachedGif:
        """Test InlineQueryResultCachedGif
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InlineQueryResultCachedGif`
        """
    ...
    def testInlineQueryResultCachedGif(self):
        """Test InlineQueryResultCachedGif"""
