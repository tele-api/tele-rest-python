...
class TestEditMessageCaptionRequest(unittest.TestCase):
    """EditMessageCaptionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EditMessageCaptionRequest:
        """Test EditMessageCaptionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EditMessageCaptionRequest`
        """
        model = EditMessageCaptionRequest()
        if include_optional:
    ...
    def testEditMessageCaptionRequest(self):
        """Test EditMessageCaptionRequest"""
