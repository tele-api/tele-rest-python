...
class TestEditMessageChecklistResponse(unittest.TestCase):
    """EditMessageChecklistResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EditMessageChecklistResponse:
        """Test EditMessageChecklistResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EditMessageChecklistResponse`
        """
        model = EditMessageChecklistResponse()
        if include_optional:
    ...
    def testEditMessageChecklistResponse(self):
        """Test EditMessageChecklistResponse"""
