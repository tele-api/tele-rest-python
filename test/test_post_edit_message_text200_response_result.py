...
class TestPostEditMessageText200ResponseResult(unittest.TestCase):
    """PostEditMessageText200ResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostEditMessageText200ResponseResult:
        """Test PostEditMessageText200ResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostEditMessageText200ResponseResult`
        """
        model = PostEditMessageText200ResponseResult()
        if include_optional:
    ...
    def testPostEditMessageText200ResponseResult(self):
        """Test PostEditMessageText200ResponseResult"""
