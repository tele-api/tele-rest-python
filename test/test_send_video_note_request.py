...
class TestSendVideoNoteRequest(unittest.TestCase):
    """SendVideoNoteRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendVideoNoteRequest:
        """Test SendVideoNoteRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendVideoNoteRequest`
        """
        model = SendVideoNoteRequest()
        if include_optional:
    ...
    def testSendVideoNoteRequest(self):
        """Test SendVideoNoteRequest"""
