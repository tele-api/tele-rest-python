...
class TestUniqueGiftInfo(unittest.TestCase):
    """UniqueGiftInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UniqueGiftInfo:
        """Test UniqueGiftInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UniqueGiftInfo`
        """
        model = UniqueGiftInfo()
        if include_optional:
