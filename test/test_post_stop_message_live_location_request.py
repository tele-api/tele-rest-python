...
class TestPostStopMessageLiveLocationRequest(unittest.TestCase):
    """PostStopMessageLiveLocationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostStopMessageLiveLocationRequest:
        """Test PostStopMessageLiveLocationRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostStopMessageLiveLocationRequest`
        """
        model = PostStopMessageLiveLocationRequest()
        if include_optional:
            return PostStopMessageLiveLocationRequest(
    ...
    def testPostStopMessageLiveLocationRequest(self):
        """Test PostStopMessageLiveLocationRequest"""
