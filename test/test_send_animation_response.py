...
class TestSendAnimationResponse(unittest.TestCase):
    """SendAnimationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendAnimationResponse:
        """Test SendAnimationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendAnimationResponse`
        """
        model = SendAnimationResponse()
        if include_optional:
    ...
    def testSendAnimationResponse(self):
        """Test SendAnimationResponse"""
