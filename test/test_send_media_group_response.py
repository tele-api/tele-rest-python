...
class TestSendMediaGroupResponse(unittest.TestCase):
    """SendMediaGroupResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendMediaGroupResponse:
        """Test SendMediaGroupResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendMediaGroupResponse`
        """
        model = SendMediaGroupResponse()
        if include_optional:
    ...
    def testSendMediaGroupResponse(self):
        """Test SendMediaGroupResponse"""
