...
class TestPostSendPollRequest(unittest.TestCase):
    """PostSendPollRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostSendPollRequest:
        """Test PostSendPollRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostSendPollRequest`
        """
        model = PostSendPollRequest()
        if include_optional:
            return PostSendPollRequest(
    ...
    def testPostSendPollRequest(self):
        """Test PostSendPollRequest"""
