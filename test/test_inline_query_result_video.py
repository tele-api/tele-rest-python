...
class TestInlineQueryResultVideo(unittest.TestCase):
    """InlineQueryResultVideo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InlineQueryResultVideo:
        """Test InlineQueryResultVideo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InlineQueryResultVideo`
        """
    ...
    def testInlineQueryResultVideo(self):
        """Test InlineQueryResultVideo"""
