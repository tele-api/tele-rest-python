...
class TestGiftInfo(unittest.TestCase):
    """GiftInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GiftInfo:
        """Test GiftInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GiftInfo`
        """
        model = GiftInfo()
        if include_optional:
            return GiftInfo(
