...
class TestEditMessageLiveLocationRequest(unittest.TestCase):
    """EditMessageLiveLocationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EditMessageLiveLocationRequest:
        """Test EditMessageLiveLocationRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EditMessageLiveLocationRequest`
        """
        model = EditMessageLiveLocationRequest()
        if include_optional:
    ...
    def testEditMessageLiveLocationRequest(self):
        """Test EditMessageLiveLocationRequest"""
