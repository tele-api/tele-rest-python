...
class TestSendMediaGroupPost200Response(unittest.TestCase):
    """SendMediaGroupPost200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendMediaGroupPost200Response:
        """Test SendMediaGroupPost200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendMediaGroupPost200Response`
        """
        model = SendMediaGroupPost200Response()
        if include_optional:
            return SendMediaGroupPost200Response(
                ok = True,
                result = [
                    tele_rest.models.message.Message(
                        message_id = 56, 
    ...
    def testSendMediaGroupPost200Response(self):
        """Test SendMediaGroupPost200Response"""
