...
class TestChatMember(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ChatMember:
        """Test ChatMember
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChatMember`
        """
        model = ChatMember()
        if include_optional:
            return ChatMember(
