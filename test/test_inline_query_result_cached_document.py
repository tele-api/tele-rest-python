...
class TestInlineQueryResultCachedDocument(unittest.TestCase):
    """InlineQueryResultCachedDocument unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InlineQueryResultCachedDocument:
        """Test InlineQueryResultCachedDocument
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InlineQueryResultCachedDocument`
        """
    ...
    def testInlineQueryResultCachedDocument(self):
        """Test InlineQueryResultCachedDocument"""
