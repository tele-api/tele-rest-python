...
class TestEditMessageChecklistRequest(unittest.TestCase):
    """EditMessageChecklistRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EditMessageChecklistRequest:
        """Test EditMessageChecklistRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EditMessageChecklistRequest`
        """
        model = EditMessageChecklistRequest()
        if include_optional:
            return EditMessageChecklistRequest(
                business_connection_id = '',
                chat_id = 56,
                message_id = 56,
                checklist = tele_rest.models.input_checklist.InputChecklist(
                    title = '0', 
                    parse_mode = '', 
                    title_entities = [
                    ...
                    tasks = [
                        tele_rest.models.input_checklist_task.InputChecklistTask(
                            id = 56, 
                            text = '0', 
                            parse_mode = '', 
                            text_entities = [
    ...
    def testEditMessageChecklistRequest(self):
        """Test EditMessageChecklistRequest"""
