...
class TestForumTopic(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ForumTopic:
        """Test ForumTopic
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ForumTopic`
        """
        model = ForumTopic()
        if include_optional:
            return ForumTopic(
