...
class TestSendMessagePostRequestReplyMarkup(unittest.TestCase):
    """SendMessagePostRequestReplyMarkup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendMessagePostRequestReplyMarkup:
        """Test SendMessagePostRequestReplyMarkup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendMessagePostRequestReplyMarkup`
        """
        model = SendMessagePostRequestReplyMarkup()
        if include_optional:
    ...
    def testSendMessagePostRequestReplyMarkup(self):
        """Test SendMessagePostRequestReplyMarkup"""
