...
class TestSendPaidMediaRequest(unittest.TestCase):
    """SendPaidMediaRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendPaidMediaRequest:
        """Test SendPaidMediaRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendPaidMediaRequest`
        """
        model = SendPaidMediaRequest()
        if include_optional:
    ...
    def testSendPaidMediaRequest(self):
        """Test SendPaidMediaRequest"""
