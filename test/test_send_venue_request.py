...
class TestSendVenueRequest(unittest.TestCase):
    """SendVenueRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendVenueRequest:
        """Test SendVenueRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendVenueRequest`
        """
        model = SendVenueRequest()
        if include_optional:
