...
class TestEditMessageTextRequest(unittest.TestCase):
    """EditMessageTextRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EditMessageTextRequest:
        """Test EditMessageTextRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EditMessageTextRequest`
        """
        model = EditMessageTextRequest()
        if include_optional:
    ...
    def testEditMessageTextRequest(self):
        """Test EditMessageTextRequest"""
