...
class TestSendChecklistResponse(unittest.TestCase):
    """SendChecklistResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendChecklistResponse:
        """Test SendChecklistResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendChecklistResponse`
        """
        model = SendChecklistResponse()
        if include_optional:
    ...
    def testSendChecklistResponse(self):
        """Test SendChecklistResponse"""
