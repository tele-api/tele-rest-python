...
class TestEncryptedCredentials(unittest.TestCase):
    """EncryptedCredentials unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EncryptedCredentials:
        """Test EncryptedCredentials
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EncryptedCredentials`
        """
    ...
    def testEncryptedCredentials(self):
        """Test EncryptedCredentials"""
