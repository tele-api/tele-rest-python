...
class TestPostSendInvoiceRequest(unittest.TestCase):
    """PostSendInvoiceRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostSendInvoiceRequest:
        """Test PostSendInvoiceRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostSendInvoiceRequest`
        """
        model = PostSendInvoiceRequest()
        if include_optional:
            return PostSendInvoiceRequest(
                chat_id = None,
    ...
    def testPostSendInvoiceRequest(self):
        """Test PostSendInvoiceRequest"""
