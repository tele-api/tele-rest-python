...
class TestChecklistTasksDone(unittest.TestCase):
    """ChecklistTasksDone unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChecklistTasksDone:
        """Test ChecklistTasksDone
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChecklistTasksDone`
        """
        model = ChecklistTasksDone()
        if include_optional:
    ...
    def testChecklistTasksDone(self):
        """Test ChecklistTasksDone"""
