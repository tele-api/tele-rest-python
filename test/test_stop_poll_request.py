...
class TestStopPollRequest(unittest.TestCase):
    """StopPollRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StopPollRequest:
        """Test StopPollRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StopPollRequest`
        """
        model = StopPollRequest()
        if include_optional:
            return StopPollRequest(
