...
class TestEditMessageCaptionPostRequest(unittest.TestCase):
    """EditMessageCaptionPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EditMessageCaptionPostRequest:
        """Test EditMessageCaptionPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EditMessageCaptionPostRequest`
        """
        model = EditMessageCaptionPostRequest()
        if include_optional:
            return EditMessageCaptionPostRequest(
    ...
    def testEditMessageCaptionPostRequest(self):
        """Test EditMessageCaptionPostRequest"""
