...
class TestInlineKeyboardMarkup(unittest.TestCase):
    """InlineKeyboardMarkup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InlineKeyboardMarkup:
        """Test InlineKeyboardMarkup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InlineKeyboardMarkup`
        """
    ...
    def testInlineKeyboardMarkup(self):
        """Test InlineKeyboardMarkup"""
