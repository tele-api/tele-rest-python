...
class TestSuggestedPostDeclined(unittest.TestCase):
    """SuggestedPostDeclined unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SuggestedPostDeclined:
        """Test SuggestedPostDeclined
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SuggestedPostDeclined`
        """
        model = SuggestedPostDeclined()
        if include_optional:
    ...
    def testSuggestedPostDeclined(self):
        """Test SuggestedPostDeclined"""
