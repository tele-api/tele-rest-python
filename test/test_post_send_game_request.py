...
class TestPostSendGameRequest(unittest.TestCase):
    """PostSendGameRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostSendGameRequest:
        """Test PostSendGameRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostSendGameRequest`
        """
        model = PostSendGameRequest()
        if include_optional:
            return PostSendGameRequest(
    ...
    def testPostSendGameRequest(self):
        """Test PostSendGameRequest"""
