...
class TestPostEditMessageTextRequest(unittest.TestCase):
    """PostEditMessageTextRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostEditMessageTextRequest:
        """Test PostEditMessageTextRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostEditMessageTextRequest`
        """
        model = PostEditMessageTextRequest()
        if include_optional:
            return PostEditMessageTextRequest(
    ...
    def testPostEditMessageTextRequest(self):
        """Test PostEditMessageTextRequest"""
