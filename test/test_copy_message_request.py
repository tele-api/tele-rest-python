...
class TestCopyMessageRequest(unittest.TestCase):
    """CopyMessageRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CopyMessageRequest:
        """Test CopyMessageRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CopyMessageRequest`
        """
        model = CopyMessageRequest()
        if include_optional:
    ...
    def testCopyMessageRequest(self):
        """Test CopyMessageRequest"""
