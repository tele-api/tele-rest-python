...
class TestChecklistTasksAdded(unittest.TestCase):
    """ChecklistTasksAdded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChecklistTasksAdded:
        """Test ChecklistTasksAdded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChecklistTasksAdded`
        """
        model = ChecklistTasksAdded()
        if include_optional:
                ...
                tasks = [
                    tele_rest.models.checklist_task.ChecklistTask(
                        ...
                        completed_by_user = tele_rest.models.user.User(
                            ...
                            has_main_web_app = True, 
                            has_topics_enabled = True, ), 
                        completed_by_chat = tele_rest.models.chat.Chat(
                            id = 56, 
                            type = 'private', 
                            title = '', 
                            username = '', 
    ...
    def testChecklistTasksAdded(self):
        """Test ChecklistTasksAdded"""
