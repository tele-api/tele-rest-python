...
class TestSendVideoNoteResponse(unittest.TestCase):
    """SendVideoNoteResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendVideoNoteResponse:
        """Test SendVideoNoteResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendVideoNoteResponse`
        """
        model = SendVideoNoteResponse()
        if include_optional:
    ...
    def testSendVideoNoteResponse(self):
        """Test SendVideoNoteResponse"""
