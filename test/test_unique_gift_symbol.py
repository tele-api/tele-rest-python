...
class TestUniqueGiftSymbol(unittest.TestCase):
    """UniqueGiftSymbol unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UniqueGiftSymbol:
        """Test UniqueGiftSymbol
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UniqueGiftSymbol`
        """
        model = UniqueGiftSymbol()
        if include_optional:
