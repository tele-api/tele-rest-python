...
class TestSendPollResponse(unittest.TestCase):
    """SendPollResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendPollResponse:
        """Test SendPollResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendPollResponse`
        """
        model = SendPollResponse()
        if include_optional:
