...
class TestReplyKeyboardRemove(unittest.TestCase):
    """ReplyKeyboardRemove unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReplyKeyboardRemove:
        """Test ReplyKeyboardRemove
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReplyKeyboardRemove`
        """
    ...
    def testReplyKeyboardRemove(self):
        """Test ReplyKeyboardRemove"""
