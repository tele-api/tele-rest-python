...
class TestEditMessageMediaRequest(unittest.TestCase):
    """EditMessageMediaRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EditMessageMediaRequest:
        """Test EditMessageMediaRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EditMessageMediaRequest`
        """
        model = EditMessageMediaRequest()
        if include_optional:
            return EditMessageMediaRequest(
    ...
    def testEditMessageMediaRequest(self):
        """Test EditMessageMediaRequest"""
