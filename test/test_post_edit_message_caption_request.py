...
class TestPostEditMessageCaptionRequest(unittest.TestCase):
    """PostEditMessageCaptionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostEditMessageCaptionRequest:
        """Test PostEditMessageCaptionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostEditMessageCaptionRequest`
        """
        model = PostEditMessageCaptionRequest()
        if include_optional:
            return PostEditMessageCaptionRequest(
    ...
    def testPostEditMessageCaptionRequest(self):
        """Test PostEditMessageCaptionRequest"""
