...
class TestSendAnimationRequest(unittest.TestCase):
    """SendAnimationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendAnimationRequest:
        """Test SendAnimationRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendAnimationRequest`
        """
        model = SendAnimationRequest()
        if include_optional:
            return SendAnimationRequest(
    ...
    def testSendAnimationRequest(self):
        """Test SendAnimationRequest"""
