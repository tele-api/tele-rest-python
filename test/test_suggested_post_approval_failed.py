...
class TestSuggestedPostApprovalFailed(unittest.TestCase):
    """SuggestedPostApprovalFailed unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SuggestedPostApprovalFailed:
        """Test SuggestedPostApprovalFailed
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SuggestedPostApprovalFailed`
        """
        model = SuggestedPostApprovalFailed()
        if include_optional:
            return SuggestedPostApprovalFailed(
                suggested_post_message = tele_rest.models.message.Message(
                    message_id = 56, 
    ...
    def testSuggestedPostApprovalFailed(self):
        """Test SuggestedPostApprovalFailed"""
