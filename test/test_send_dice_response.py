...
class TestSendDiceResponse(unittest.TestCase):
    """SendDiceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendDiceResponse:
        """Test SendDiceResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendDiceResponse`
        """
        model = SendDiceResponse()
        if include_optional:
