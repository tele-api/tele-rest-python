...
class TestSendAudioResponse(unittest.TestCase):
    """SendAudioResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendAudioResponse:
        """Test SendAudioResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendAudioResponse`
        """
        model = SendAudioResponse()
        if include_optional:
    ...
    def testSendAudioResponse(self):
        """Test SendAudioResponse"""
