...
class TestSendPhotoRequest(unittest.TestCase):
    """SendPhotoRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendPhotoRequest:
        """Test SendPhotoRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendPhotoRequest`
        """
        model = SendPhotoRequest()
        if include_optional:
