...
class TestInlineQueryResultDocument(unittest.TestCase):
    """InlineQueryResultDocument unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InlineQueryResultDocument:
        """Test InlineQueryResultDocument
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InlineQueryResultDocument`
        """
    ...
    def testInlineQueryResultDocument(self):
        """Test InlineQueryResultDocument"""
