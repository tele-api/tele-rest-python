...
class TestVideoChatParticipantsInvited(unittest.TestCase):
    """VideoChatParticipantsInvited unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VideoChatParticipantsInvited:
        """Test VideoChatParticipantsInvited
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VideoChatParticipantsInvited`
        """
    ...
    def testVideoChatParticipantsInvited(self):
        """Test VideoChatParticipantsInvited"""
