...
class TestChecklistTask(unittest.TestCase):
    """ChecklistTask unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChecklistTask:
        """Test ChecklistTask
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChecklistTask`
        """
        model = ChecklistTask()
        if include_optional:
