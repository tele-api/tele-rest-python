...
class TestSendGameResponse(unittest.TestCase):
    """SendGameResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendGameResponse:
        """Test SendGameResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendGameResponse`
        """
        model = SendGameResponse()
        if include_optional:
