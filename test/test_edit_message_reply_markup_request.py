...
class TestEditMessageReplyMarkupRequest(unittest.TestCase):
    """EditMessageReplyMarkupRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EditMessageReplyMarkupRequest:
        """Test EditMessageReplyMarkupRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EditMessageReplyMarkupRequest`
        """
        model = EditMessageReplyMarkupRequest()
        if include_optional:
    ...
    def testEditMessageReplyMarkupRequest(self):
        """Test EditMessageReplyMarkupRequest"""
