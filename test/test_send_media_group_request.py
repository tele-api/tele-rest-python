...
class TestSendMediaGroupRequest(unittest.TestCase):
    """SendMediaGroupRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendMediaGroupRequest:
        """Test SendMediaGroupRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendMediaGroupRequest`
        """
        model = SendMediaGroupRequest()
        if include_optional:
    ...
    def testSendMediaGroupRequest(self):
        """Test SendMediaGroupRequest"""
