...
class TestGiveawayCompleted(unittest.TestCase):
    """GiveawayCompleted unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GiveawayCompleted:
        """Test GiveawayCompleted
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GiveawayCompleted`
        """
        model = GiveawayCompleted()
        if include_optional:
    ...
    def testGiveawayCompleted(self):
        """Test GiveawayCompleted"""
