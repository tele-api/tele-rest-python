...
class TestInlineQueryResultVoice(unittest.TestCase):
    """InlineQueryResultVoice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InlineQueryResultVoice:
        """Test InlineQueryResultVoice
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InlineQueryResultVoice`
        """
    ...
    def testInlineQueryResultVoice(self):
        """Test InlineQueryResultVoice"""
