...
class TestSendChecklistRequest(unittest.TestCase):
    """SendChecklistRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendChecklistRequest:
        """Test SendChecklistRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendChecklistRequest`
        """
        model = SendChecklistRequest()
        if include_optional:
            return SendChecklistRequest(
    ...
    def testSendChecklistRequest(self):
        """Test SendChecklistRequest"""
