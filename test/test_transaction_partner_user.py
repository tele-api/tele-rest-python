...
class TestTransactionPartnerUser(unittest.TestCase):
    """TransactionPartnerUser unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransactionPartnerUser:
        """Test TransactionPartnerUser
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransactionPartnerUser`
        """
        model = TransactionPartnerUser()
        if include_optional:
    ...
    def testTransactionPartnerUser(self):
        """Test TransactionPartnerUser"""
