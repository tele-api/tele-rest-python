...
class TestEditMessageTextPostRequest(unittest.TestCase):
    """EditMessageTextPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EditMessageTextPostRequest:
        """Test EditMessageTextPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EditMessageTextPostRequest`
        """
        model = EditMessageTextPostRequest()
        if include_optional:
            return EditMessageTextPostRequest(
    ...
    def testEditMessageTextPostRequest(self):
        """Test EditMessageTextPostRequest"""
