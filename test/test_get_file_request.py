...
class TestGetFileRequest(unittest.TestCase):
    """GetFileRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFileRequest:
        """Test GetFileRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFileRequest`
        """
