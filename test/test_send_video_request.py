...
class TestSendVideoRequest(unittest.TestCase):
    """SendVideoRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendVideoRequest:
        """Test SendVideoRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendVideoRequest`
        """
        model = SendVideoRequest()
        if include_optional:
