...
class TestStickerSet(unittest.TestCase):
    """StickerSet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StickerSet:
        """Test StickerSet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StickerSet`
        """
        model = StickerSet()
        if include_optional:
            return StickerSet(
