...
class TestSuggestedPostRefunded(unittest.TestCase):
    """SuggestedPostRefunded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SuggestedPostRefunded:
        """Test SuggestedPostRefunded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SuggestedPostRefunded`
        """
        model = SuggestedPostRefunded()
        if include_optional:
    ...
    def testSuggestedPostRefunded(self):
        """Test SuggestedPostRefunded"""
