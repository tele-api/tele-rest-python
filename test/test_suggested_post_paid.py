...
class TestSuggestedPostPaid(unittest.TestCase):
    """SuggestedPostPaid unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SuggestedPostPaid:
        """Test SuggestedPostPaid
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SuggestedPostPaid`
        """
        model = SuggestedPostPaid()
        if include_optional:
    ...
    def testSuggestedPostPaid(self):
        """Test SuggestedPostPaid"""
