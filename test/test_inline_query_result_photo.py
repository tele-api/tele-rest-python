...
class TestInlineQueryResultPhoto(unittest.TestCase):
    """InlineQueryResultPhoto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InlineQueryResultPhoto:
        """Test InlineQueryResultPhoto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InlineQueryResultPhoto`
        """
    ...
    def testInlineQueryResultPhoto(self):
        """Test InlineQueryResultPhoto"""
