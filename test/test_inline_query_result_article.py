...
class TestInlineQueryResultArticle(unittest.TestCase):
    """InlineQueryResultArticle unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InlineQueryResultArticle:
        """Test InlineQueryResultArticle
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InlineQueryResultArticle`
        """
    ...
    def testInlineQueryResultArticle(self):
        """Test InlineQueryResultArticle"""
