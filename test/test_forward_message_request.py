...
class TestForwardMessageRequest(unittest.TestCase):
    """ForwardMessageRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ForwardMessageRequest:
        """Test ForwardMessageRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ForwardMessageRequest`
        """
    ...
    def testForwardMessageRequest(self):
        """Test ForwardMessageRequest"""
