...
class TestGetUpdatesResponse(unittest.TestCase):
    """GetUpdatesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetUpdatesResponse:
        """Test GetUpdatesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUpdatesResponse`
        """
        model = GetUpdatesResponse()
        if include_optional:
    ...
    def testGetUpdatesResponse(self):
        """Test GetUpdatesResponse"""
