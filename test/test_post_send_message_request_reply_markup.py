...
class TestPostSendMessageRequestReplyMarkup(unittest.TestCase):
    """PostSendMessageRequestReplyMarkup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostSendMessageRequestReplyMarkup:
        """Test PostSendMessageRequestReplyMarkup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostSendMessageRequestReplyMarkup`
        """
        model = PostSendMessageRequestReplyMarkup()
        if include_optional:
            return PostSendMessageRequestReplyMarkup(
                inline_keyboard = [
                    [
    ...
    def testPostSendMessageRequestReplyMarkup(self):
        """Test PostSendMessageRequestReplyMarkup"""
