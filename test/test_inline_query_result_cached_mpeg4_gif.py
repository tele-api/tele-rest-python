...
class TestInlineQueryResultCachedMpeg4Gif(unittest.TestCase):
    """InlineQueryResultCachedMpeg4Gif unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InlineQueryResultCachedMpeg4Gif:
        """Test InlineQueryResultCachedMpeg4Gif
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InlineQueryResultCachedMpeg4Gif`
        """
    ...
    def testInlineQueryResultCachedMpeg4Gif(self):
        """Test InlineQueryResultCachedMpeg4Gif"""
