...
class TestSendPhotoResponse(unittest.TestCase):
    """SendPhotoResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendPhotoResponse:
        """Test SendPhotoResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendPhotoResponse`
        """
        model = SendPhotoResponse()
        if include_optional:
    ...
    def testSendPhotoResponse(self):
        """Test SendPhotoResponse"""
