...
class TestPostEditMessageReplyMarkupRequest(unittest.TestCase):
    """PostEditMessageReplyMarkupRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostEditMessageReplyMarkupRequest:
        """Test PostEditMessageReplyMarkupRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostEditMessageReplyMarkupRequest`
        """
        model = PostEditMessageReplyMarkupRequest()
        if include_optional:
            return PostEditMessageReplyMarkupRequest(
    ...
    def testPostEditMessageReplyMarkupRequest(self):
        """Test PostEditMessageReplyMarkupRequest"""
