...
class TestForwardMessageResponse(unittest.TestCase):
    """ForwardMessageResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ForwardMessageResponse:
        """Test ForwardMessageResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ForwardMessageResponse`
        """
        model = ForwardMessageResponse()
        if include_optional:
    ...
    def testForwardMessageResponse(self):
        """Test ForwardMessageResponse"""
