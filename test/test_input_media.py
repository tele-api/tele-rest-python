...
class TestInputMedia(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> InputMedia:
        """Test InputMedia
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InputMedia`
        """
        model = InputMedia()
        if include_optional:
            return InputMedia(
