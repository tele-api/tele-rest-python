...
class TestSendLocationResponse(unittest.TestCase):
    """SendLocationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendLocationResponse:
        """Test SendLocationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendLocationResponse`
        """
        model = SendLocationResponse()
        if include_optional:
    ...
    def testSendLocationResponse(self):
        """Test SendLocationResponse"""
