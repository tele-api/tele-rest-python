...
class TestBusinessIntro(unittest.TestCase):
    """BusinessIntro unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BusinessIntro:
        """Test BusinessIntro
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BusinessIntro`
        """
        model = BusinessIntro()
        if include_optional:
