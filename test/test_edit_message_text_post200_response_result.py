...
class TestEditMessageTextPost200ResponseResult(unittest.TestCase):
    """EditMessageTextPost200ResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EditMessageTextPost200ResponseResult:
        """Test EditMessageTextPost200ResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EditMessageTextPost200ResponseResult`
        """
        model = EditMessageTextPost200ResponseResult()
        if include_optional:
            return EditMessageTextPost200ResponseResult(
                message_id = 56,
                message_thread_id = 56,
                var_from = tele_rest.models.user.User(
                    id = 56, 
                    is_bot = True, 
                    first_name = '', 
                    last_name = '', 
                ...
                reply_to_message = tele_rest.models.message.Message(
                    ...
                    giveaway_completed = tele_rest.models.giveaway_completed.GiveawayCompleted(
                        winner_count = 56, 
                        unclaimed_prize_count = 56, 
                        giveaway_message = tele_rest.models.message.Message(
                            message_id = 56, 
                            message_thread_id = 56, 
                            sender_boost_count = 56, 
                            date = 56, 
                ...
                reply_to_story = tele_rest.models.story.Story(
                    chat = tele_rest.models.chat.Chat(
                        ...
                        is_forum = True, ), 
                    id = 56, ),
                via_bot = tele_rest.models.user.User(
                    id = 56, 
                    is_bot = True, 
                    first_name = '', 
                    last_name = '', 
                ...
                left_chat_member = tele_rest.models.user.User(
                    id = 56, 
                    is_bot = True, 
                    first_name = '', 
                    last_name = '', 
                ...
                passport_data = tele_rest.models.passport_data.PassportData(
                    ...
                    credentials = tele_rest.models.encrypted_credentials.EncryptedCredentials(
                        ...
                        secret = '', ), ),
                proximity_alert_triggered = tele_rest.models.proximity_alert_triggered.ProximityAlertTriggered(
                    traveler = tele_rest.models.user.User(
                        id = 56, 
                        is_bot = True, 
                        first_name = '', 
                        last_name = '', 
                        ...
                        can_connect_to_business = True, 
                        has_main_web_app = True, ), 
                    watcher = tele_rest.models.user.User(
                        id = 56, 
                        is_bot = True, 
                        first_name = '', 
                        last_name = '', 
    ...
    def testEditMessageTextPost200ResponseResult(self):
        """Test EditMessageTextPost200ResponseResult"""
