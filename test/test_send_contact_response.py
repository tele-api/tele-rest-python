...
class TestSendContactResponse(unittest.TestCase):
    """SendContactResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendContactResponse:
        """Test SendContactResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendContactResponse`
        """
        model = SendContactResponse()
        if include_optional:
    ...
    def testSendContactResponse(self):
        """Test SendContactResponse"""
