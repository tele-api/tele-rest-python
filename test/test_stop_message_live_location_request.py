...
class TestStopMessageLiveLocationRequest(unittest.TestCase):
    """StopMessageLiveLocationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StopMessageLiveLocationRequest:
        """Test StopMessageLiveLocationRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StopMessageLiveLocationRequest`
        """
        model = StopMessageLiveLocationRequest()
        if include_optional:
    ...
    def testStopMessageLiveLocationRequest(self):
        """Test StopMessageLiveLocationRequest"""
