...
class TestPostGetUpdates200Response(unittest.TestCase):
    """PostGetUpdates200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostGetUpdates200Response:
        """Test PostGetUpdates200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostGetUpdates200Response`
        """
        model = PostGetUpdates200Response()
        if include_optional:
            return PostGetUpdates200Response(
                ok = True,
                result = [
                    tele_rest.models.update.Update(
                        update_id = 56, 
                        message = tele_rest.models.message.Message(
                            message_id = 56, 
                        ...
                        channel_post = , 
                        edited_channel_post = , 
                        business_connection = tele_rest.models.business_connection.BusinessConnection(
                            id = '', 
                            user = , 
                            user_chat_id = 56, 
                            date = 56, 
                        ...
                        deleted_business_messages = tele_rest.models.business_messages_deleted.BusinessMessagesDeleted(
                            business_connection_id = '', 
                            chat = , 
                            message_ids = [
                                56
                                ], ), 
                        message_reaction = tele_rest.models.message_reaction_updated.MessageReactionUpdated(
                            chat = , 
                            message_id = 56, 
                            actor_chat = , 
                            date = 56, 
                        ...
                        message_reaction_count = tele_rest.models.message_reaction_count_updated.MessageReactionCountUpdated(
                            chat = , 
                            message_id = 56, 
                            date = 56, 
                            reactions = [
                                tele_rest.models.reaction_count.ReactionCount(
                                    type = null, 
                                    total_count = 56, )
                                ], ), 
                        inline_query = tele_rest.models.inline_query.InlineQuery(
                            id = '', 
                            from = , 
                            query = '', 
                            offset = '', 
                            chat_type = 'sender', ), 
                        chosen_inline_result = tele_rest.models.chosen_inline_result.ChosenInlineResult(
                            result_id = '', 
                            from = , 
                            inline_message_id = '', 
                            query = '', ), 
                        callback_query = tele_rest.models.callback_query.CallbackQuery(
                            id = '', 
                            from = , 
                            inline_message_id = '', 
                            chat_instance = '', 
                            game_short_name = '', ), 
                        shipping_query = tele_rest.models.shipping_query.ShippingQuery(
                            id = '', 
                            from = , 
                            invoice_payload = '', 
                            shipping_address = tele_rest.models.shipping_address.ShippingAddress(
                                ...
                                street_line2 = '', 
                                post_code = '', ), ), 
                        pre_checkout_query = tele_rest.models.pre_checkout_query.PreCheckoutQuery(
                            id = '', 
                            from = , 
                            currency = '', 
                            total_amount = 56, 
                            invoice_payload = '', 
                            shipping_option_id = '', ), 
                        purchased_paid_media = tele_rest.models.paid_media_purchased.PaidMediaPurchased(
                            from = , 
                            paid_media_payload = '', ), 
                        poll = , 
                        poll_answer = tele_rest.models.poll_answer.PollAnswer(
                            poll_id = '', 
                            voter_chat = , 
                            option_ids = [
                                56
                                ], ), 
                        my_chat_member = tele_rest.models.chat_member_updated.ChatMemberUpdated(
                            chat = , 
                            from = , 
                            date = 56, 
                            old_chat_member = null, 
                            new_chat_member = null, 
                            invite_link = tele_rest.models.chat_invite_link.ChatInviteLink(
                                invite_link = '', 
                                creator = , 
                        ...
                        chat_member = tele_rest.models.chat_member_updated.ChatMemberUpdated(
                            chat = , 
                            from = , 
                            date = 56, 
                            old_chat_member = null, 
                            ...
                            via_join_request = True, 
                            via_chat_folder_invite_link = True, ), 
                        chat_join_request = tele_rest.models.chat_join_request.ChatJoinRequest(
                            chat = , 
                            from = , 
                            user_chat_id = 56, 
                            date = 56, 
                            bio = '', ), 
                        chat_boost = tele_rest.models.chat_boost_updated.ChatBoostUpdated(
                            chat = , 
                            boost = tele_rest.models.chat_boost.ChatBoost(
                                boost_id = '', 
                                add_date = 56, 
                                expiration_date = 56, 
                                source = null, ), ), 
                        removed_chat_boost = tele_rest.models.chat_boost_removed.ChatBoostRemoved(
                            chat = , 
                            boost_id = '', 
                            remove_date = 56, 
                            source = null, ), )
    ...
    def testPostGetUpdates200Response(self):
        """Test PostGetUpdates200Response"""
