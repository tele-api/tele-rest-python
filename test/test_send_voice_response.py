...
class TestSendVoiceResponse(unittest.TestCase):
    """SendVoiceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendVoiceResponse:
        """Test SendVoiceResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendVoiceResponse`
        """
        model = SendVoiceResponse()
        if include_optional:
    ...
    def testSendVoiceResponse(self):
        """Test SendVoiceResponse"""
