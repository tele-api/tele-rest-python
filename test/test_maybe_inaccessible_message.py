...
class TestMaybeInaccessibleMessage(unittest.TestCase):
    """MaybeInaccessibleMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MaybeInaccessibleMessage:
        """Test MaybeInaccessibleMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MaybeInaccessibleMessage`
        """
        model = MaybeInaccessibleMessage()
        if include_optional:
    ...
    def testMaybeInaccessibleMessage(self):
        """Test MaybeInaccessibleMessage"""
