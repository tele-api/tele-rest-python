...
class TestOwnedGiftUnique(unittest.TestCase):
    """OwnedGiftUnique unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OwnedGiftUnique:
        """Test OwnedGiftUnique
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OwnedGiftUnique`
        """
        model = OwnedGiftUnique()
        if include_optional:
