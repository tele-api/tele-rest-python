...
class TestMessageOrigin(unittest.TestCase):
    """MessageOrigin unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageOrigin:
        """Test MessageOrigin
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageOrigin`
        """
        model = MessageOrigin()
        if include_optional:
