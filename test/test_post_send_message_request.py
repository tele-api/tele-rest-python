...
class TestPostSendMessageRequest(unittest.TestCase):
    """PostSendMessageRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostSendMessageRequest:
        """Test PostSendMessageRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostSendMessageRequest`
        """
        model = PostSendMessageRequest()
        if include_optional:
    ...
    def testPostSendMessageRequest(self):
        """Test PostSendMessageRequest"""
