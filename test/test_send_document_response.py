...
class TestSendDocumentResponse(unittest.TestCase):
    """SendDocumentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendDocumentResponse:
        """Test SendDocumentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendDocumentResponse`
        """
        model = SendDocumentResponse()
        if include_optional:
    ...
    def testSendDocumentResponse(self):
        """Test SendDocumentResponse"""
