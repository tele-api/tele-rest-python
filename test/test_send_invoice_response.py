...
class TestSendInvoiceResponse(unittest.TestCase):
    """SendInvoiceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendInvoiceResponse:
        """Test SendInvoiceResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendInvoiceResponse`
        """
        model = SendInvoiceResponse()
        if include_optional:
    ...
    def testSendInvoiceResponse(self):
        """Test SendInvoiceResponse"""
