...
class TestSendStickerResponse(unittest.TestCase):
    """SendStickerResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendStickerResponse:
        """Test SendStickerResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendStickerResponse`
        """
        model = SendStickerResponse()
        if include_optional:
    ...
    def testSendStickerResponse(self):
        """Test SendStickerResponse"""
