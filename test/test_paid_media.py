...
class TestPaidMedia(unittest.TestCase):
    """PaidMedia unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaidMedia:
        """Test PaidMedia
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaidMedia`
        """
        model = PaidMedia()
        if include_optional:
            return PaidMedia(
