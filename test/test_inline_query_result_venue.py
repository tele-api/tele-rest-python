...
class TestInlineQueryResultVenue(unittest.TestCase):
    """InlineQueryResultVenue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InlineQueryResultVenue:
        """Test InlineQueryResultVenue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InlineQueryResultVenue`
        """
    ...
    def testInlineQueryResultVenue(self):
        """Test InlineQueryResultVenue"""
