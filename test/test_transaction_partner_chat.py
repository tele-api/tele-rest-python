...
class TestTransactionPartnerChat(unittest.TestCase):
    """TransactionPartnerChat unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransactionPartnerChat:
        """Test TransactionPartnerChat
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransactionPartnerChat`
        """
        model = TransactionPartnerChat()
        if include_optional:
    ...
    def testTransactionPartnerChat(self):
        """Test TransactionPartnerChat"""
