...
class TestGetAvailableGiftsPost200Response(unittest.TestCase):
    """GetAvailableGiftsPost200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAvailableGiftsPost200Response:
        """Test GetAvailableGiftsPost200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAvailableGiftsPost200Response`
        """
        model = GetAvailableGiftsPost200Response()
        if include_optional:
    ...
    def testGetAvailableGiftsPost200Response(self):
        """Test GetAvailableGiftsPost200Response"""
