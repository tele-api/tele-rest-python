...
json = "{}"
# create an instance of EditMessageTextPost200ResponseResult from a JSON string
edit_message_text_post200_response_result_instance = EditMessageTextPost200ResponseResult.from_json(json)
# print the JSON string representation of the object
print(EditMessageTextPost200ResponseResult.to_json())

# convert the object into a dict
edit_message_text_post200_response_result_dict = edit_message_text_post200_response_result_instance.to_dict()
# create an instance of EditMessageTextPost200ResponseResult from a dict
edit_message_text_post200_response_result_from_dict = EditMessageTextPost200ResponseResult.from_dict(edit_message_text_post200_response_result_dict)
```
