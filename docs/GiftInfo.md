...
**prepaid_upgrade_star_count** | **int** | *Optional*. Number of Telegram Stars that were prepaid for the ability to upgrade the gift | [optional] 
**is_upgrade_separate** | **bool** | *Optional*. *True*, if the gift&#39;s upgrade was purchased after the gift was sent | [optional] [default to True]
