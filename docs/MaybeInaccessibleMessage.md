...
**message_thread_id** | **int** | *Optional*. Unique identifier of a message thread or forum topic to which the message belongs; for supergroups and private chats only | [optional] 
**direct_messages_topic** | [**DirectMessagesTopic**](DirectMessagesTopic.md) |  | [optional] 
...
**is_topic_message** | **bool** | *Optional*. *True*, if the message is sent to a topic in a forum supergroup or a private chat with the bot | [optional] [default to True]
...
**reply_to_checklist_task_id** | **int** | *Optional*. Identifier of the specific checklist task that is being replied to | [optional] 
...
**is_paid_post** | **bool** | *Optional*. *True*, if the message is a paid post. Note that such posts must not be deleted for 24 hours to receive the payment and can&#39;t be edited. | [optional] [default to True]
...
**suggested_post_info** | [**SuggestedPostInfo**](SuggestedPostInfo.md) |  | [optional] 
...
**gift_upgrade_sent** | [**GiftInfo**](GiftInfo.md) |  | [optional] 
...
**suggested_post_approved** | [**SuggestedPostApproved**](SuggestedPostApproved.md) |  | [optional] 
**suggested_post_approval_failed** | [**SuggestedPostApprovalFailed**](SuggestedPostApprovalFailed.md) |  | [optional] 
**suggested_post_declined** | [**SuggestedPostDeclined**](SuggestedPostDeclined.md) |  | [optional] 
**suggested_post_paid** | [**SuggestedPostPaid**](SuggestedPostPaid.md) |  | [optional] 
**suggested_post_refunded** | [**SuggestedPostRefunded**](SuggestedPostRefunded.md) |  | [optional] 
