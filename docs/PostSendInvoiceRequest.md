...
post_send_invoice_request_instance = PostSendInvoiceRequest.from_json(json)
# print the JSON string representation of the object
print(PostSendInvoiceRequest.to_json())

# convert the object into a dict
post_send_invoice_request_dict = post_send_invoice_request_instance.to_dict()
# create an instance of PostSendInvoiceRequest from a dict
post_send_invoice_request_from_dict = PostSendInvoiceRequest.from_dict(post_send_invoice_request_dict)
```
