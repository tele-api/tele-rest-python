...
json = "{}"
# create an instance of CreateInvoiceLinkPostRequest from a JSON string
create_invoice_link_post_request_instance = CreateInvoiceLinkPostRequest.from_json(json)
# print the JSON string representation of the object
print(CreateInvoiceLinkPostRequest.to_json())

# convert the object into a dict
create_invoice_link_post_request_dict = create_invoice_link_post_request_instance.to_dict()
# create an instance of CreateInvoiceLinkPostRequest from a dict
create_invoice_link_post_request_from_dict = CreateInvoiceLinkPostRequest.from_dict(create_invoice_link_post_request_dict)
```
